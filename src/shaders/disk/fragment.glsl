...
void main() {
    // Hardcoded radii matching Constants.js to ensure shader works independently if needed, 
    // but ideally passed as uniforms or defines. For now keeping logic as is.
